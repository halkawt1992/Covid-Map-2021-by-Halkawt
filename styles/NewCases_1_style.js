...
var style_NewCases_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("11/12/21");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 1036373.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1036373.000000 && value <= 3838308.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3838308.000000 && value <= 9487302.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 9487302.000000 && value <= 34426036.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 34426036.000000 && value <= 46991304.000000) {
            style = [ new ol.style.Style({
